...
export const createNodes: CreateNodes<FeaturePluginOptions> = [
...
function getStartTargetConfig(options: FeaturePluginOptions, projectRoot: string) {
  const targetConfig: TargetConfiguration = {
    command: `next start`,
    options: {
      cwd: projectRoot,
...
function getStaticServeTargetConfig(options: FeaturePluginOptions) {
  const targetConfig: TargetConfiguration = {
...
function normalizeOptions(options: FeaturePluginOptions): FeaturePluginOptions {
  options ??= {};
